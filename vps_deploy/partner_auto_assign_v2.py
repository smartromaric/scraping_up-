        ...
        for p_dir in partners:
            ...
            for i, d in enumerate(items):
                ...
                if immat:
                    ...
                    is_assigned = (d.get("assignment_status") == "DONE" or d.get("owner_approval_status") == "DONE")
            ...
            while True:
                try:
                    ...
                    try:
                        ...
                        driver.execute_script("arguments[0].scrollIntoView({block:'center'});", pts)
                        time.sleep(1)
                        
                        try:
                            ActionChains(driver).move_to_element(pts).click().perform()
                        except:
                        ...
                        if target_attrib:
                            driver.execute_script("arguments[0].style.border='3px solid green';", target_attrib)
                            ...
                            log(f"      ⚠️ Bouton 'Attribuer' non visible pour {imm}.", "WARNING")
                    except Exception as e:
